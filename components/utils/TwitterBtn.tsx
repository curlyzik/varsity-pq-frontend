  ...
  return (
    <Btn>
      <a
        href={twitterLink}
        target={"_blank"}
        className="flex items-center justify-center rounded-md bg-[#1A91DA] px-3 py-2 text-base font-semibold capitalize text-white hover:bg-[#0F84B4]"
      >
        Share to Twitter
