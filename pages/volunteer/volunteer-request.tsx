...
const AdminRequest = () => {
  return (
    <div>
      ...
      <div className="bg-white px-6 pt-14 pb-10 dark:bg-[#111] lg:px-0">
        <div className="animate__animated animate__fadeInUp w-full">
          <div
            className="mx-auto flex flex-col items-center justify-center 
                      gap-y-8 gap-x-10 rounded-md p-8 text-center dark:bg-black border 
                      lg:w-[1024px] lg:flex-row lg:text-left"
          >
            <img src="/others/admin-req.svg" className="h-[230px]" />
            <div>
              <h1 className="mb-0 text-3xl font-bold dark:text-white lg:text-4xl">
                Volunteer Request
              </h1>
